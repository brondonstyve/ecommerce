                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <span class="copyright">
								...
								Copyright &copy;<script>document.write(new Date().getFullYear());</script> Tout droit reservé | Refait <i class="fa fa-heart-o" aria-hidden="true"></i> par <a href="https://www.services-technologiques.com" target="_blank">Brondon styve</a>
							<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
							</span>
                    </div>
                </div>
